...
export const useAddParkingAvenue = () => {
    return useMutation({
        mutationFn: async (data: CreateParkingAvenue) => {
            ...
            if (data.endLatitude !== undefined && data.endLatitude !== null) {
                formData.append("endLatitude", data.endLatitude.toString());
            }
            if (data.endLongitude !== undefined && data.endLongitude !== null) {
                formData.append("endLongitude", data.endLongitude.toString());
            }
